...
export default function Footer() {
    ...
    return (
        <motion.footer
            className="border-t border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-slate-950/50 py-8 mt-auto"
            ...
            <div className="max-w-6xl mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-6">
                    ...
                    <div className="flex flex-wrap gap-6">
                        {['Home', 'Features', 'Terms', 'Privacy'].map((link, i) => (
                            <motion.a
                                key={link}
                ...
                {/* Copyright - Centered */}
                <motion.div
                    className="text-center pt-4 border-t border-slate-200 dark:border-white/10"
                    initial={{ opacity: 0 }}
